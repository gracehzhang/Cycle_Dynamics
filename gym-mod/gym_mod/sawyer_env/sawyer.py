...
class SawyerEnv(BaseEnv):
    def __init__(self, xml_path, background="Simple", **kwargs):
        ...
        self.use_robot_indicator = False #kwargs["use_robot_indicator"]
        self.use_target_robot_indicator = False #kwargs["use_target_robot_indicator"]
    ...
    def observation_space(self):
        ...
        observation_space = spaces.Box(low=-1.0, high=1, shape=observation.shape)
    ...
    def _get_obs(self):
        ...
        di = np.concatenate([v for (k,v) in di.items()])
        return di

...
def get_options():
    ...
    parser.add_argument('--device_ids', type=list, default=[0], help='batch size')
    ...
    parser.add_argument("--env", default="gym_mod:GymHalfCheetahArmature-v0")
    ...
    parser.add_argument('--data_type2', type=str, default='arm', help='data type')

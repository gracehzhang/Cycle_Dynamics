    ...
    for iteration in range(3):
        ...
        for batch_id in range(start_id,end_id):
            ...
            if (batch_id + 1) % args.eval_gap == 0:
                ...
                print('iter: {}  best_reward: {:.1f}  cur_reward: {:.1f} cur_success: {:.1f}'.format(iter, best_reward,reward,success_rate))
                txt_logs.write('iter: {}  best_reward: {:.1f}  cur_reward: {:.1f} cur_succes_rate: {:.1f}\n'.format(iter, best_reward, reward, success_rate))
                txt_logs.flush()
        ...
        for batch_id in range(start_id,end_id):
            ...
            if (batch_id + 1) % args.eval_gap == 0:
                ...
                print('iter: {}  best_reward: {:.1f}  cur_reward: {:.1f} cur_success: {:.1f}'.format(iter, best_reward,reward,success_rate))
                txt_logs.write('iter: {}  best_reward: {:.1f}  cur_reward: {:.1f} cur_success :{:.1f}\n'.format(iter, best_reward, reward, success_rate))
                txt_logs.flush()
